...
from .pipeline_state import stage2c_output_signature, verification_rows_for_stage2c, verification_signature
...
class Stage3ChunkBuilder:
    ...
    async def start(self, postprocess_job_id: int) -> dict[str, Any]:
        ...
        if self._verification_store is not None:
            ...
            current_verification_signature = verification_signature(signature_rows)
