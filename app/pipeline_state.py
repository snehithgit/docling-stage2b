...
def stage2c_freshness(result_dir: Path, verification_rows: list[dict[str, Any]], *, rule_version: str | None = None) -> dict[str, Any]:
    result_dir = Path(result_dir)
    state = load_json(result_dir / "stage2c_backfill.json")
    current_verification = verification_signature(verification_rows)
