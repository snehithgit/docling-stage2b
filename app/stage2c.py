...
STAGE2C_RULE_VERSION = "stage2c-source-fidelity-v7"
...
def source_transcription_safety_profile(original: str, proposed: str, *, source_type: str = "text") -> dict[str, Any]:
    ...
    source_actions = [match.group(0).casefold() for match in ACTION_VERB_RE.finditer(_norm(original))]
    proposed_actions = [match.group(0).casefold() for match in ACTION_VERB_RE.finditer(_norm(proposed))]
    missing_actions = sorted(set(source_actions) - set(proposed_actions))
