...
| Retrieval + answers | RAG quality performs deterministic local Stage 3 search first. Answer generation is optional and explicitly selectable between Pi5, OnePlus, or Groq; the same evidence can be copied as a portable prompt with zero model calls. |


## Stage-wise book workflow · version 2026.09.15.34
