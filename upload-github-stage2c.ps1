...
if ($Remotes -contains "origin") { & git remote set-url origin $GiteaRepoUrl } else { & git remote add origin $GiteaRepoUrl }
Assert-LastExitCode "Failed to configure the Gitea origin remote"
if ($Remotes -contains "github") { & git remote set-url github $GitHubRepoUrl } else { & git remote add github $GitHubRepoUrl }
Assert-LastExitCode "Failed to configure the GitHub reference remote"
