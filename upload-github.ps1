...
# Sync the branch before creating a commit. If this device already has edits,
# preserve them in a temporary stash, update to the latest Gitea base, and then
# restore the edits. This prevents a laptop/mobile commit from being created on
# a stale base merely because the other device pushed first.
